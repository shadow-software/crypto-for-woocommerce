	...
	public static function all(): array {
		...
		foreach ( Networks::all() as $slug => $network ) {
			$assets[ 'eth:' . $slug ] = array(
				...
				'symbol'       => 'ETH',
				'label'        => __( 'Ether (ETH)', 'shadowpay-crypto-for-woocommerce' ),
				'network'      => $slug,
				'decimals'     => 18,
		...
		$assets['btc:bitcoin'] = array(
			...
			'kind'         => self::KIND_BTC,
			'symbol'       => 'BTC',
			'label'        => __( 'Bitcoin (BTC)', 'shadowpay-crypto-for-woocommerce' ),
			'network'      => 'bitcoin',
			'decimals'     => 8,
	...
	private static function evm_tokens( string $network ): array {
		...
		$map = array(
			'USDC' => array(
				...
				'label'        => __( 'USD Coin (USDC)', 'shadowpay-crypto-for-woocommerce' ),
				'decimals'     => 6,
				'contracts'    => array(
			...
			'USDT' => array(
				'coingecko_id' => 'tether',
				'label'        => __( 'Tether (USDT)', 'shadowpay-crypto-for-woocommerce' ),
				'decimals'     => 6,
				'contracts'    => array(
