...
final class BlocksSupport extends AbstractPaymentMethodType {
	...
	public function get_payment_method_script_handles(): array {
		...
		if ( function_exists( 'wp_set_script_translations' ) ) {
			wp_set_script_translations( $handle, 'shadowpay-crypto-for-woocommerce' );
		}
	...
	public function get_payment_method_data(): array {
		...
		return array(
			'title'       => $gateway instanceof Gateway ? $gateway->title : __( 'Pay with crypto (ETH, USDC, USDT, BTC)', 'shadowpay-crypto-for-woocommerce' ),
