...
final class Networks {
	...
	public static function all(): array {
		return array(
			'ethereum' => array(
				'slug'                  => 'ethereum',
				'name'                  => __( 'Ethereum', 'shadowpay-crypto-for-woocommerce' ),
				'chain_id'              => 1,
				'currency'              => 'ETH',
			...
			'base'     => array(
				'slug'                  => 'base',
				'name'                  => __( 'Base', 'shadowpay-crypto-for-woocommerce' ),
				'chain_id'              => 8453,
				'currency'              => 'ETH',
			...
			'arbitrum' => array(
				'slug'                  => 'arbitrum',
				'name'                  => __( 'Arbitrum One', 'shadowpay-crypto-for-woocommerce' ),
				'chain_id'              => 42161,
				'currency'              => 'ETH',
			...
			'optimism' => array(
				'slug'                  => 'optimism',
				'name'                  => __( 'OP Mainnet', 'shadowpay-crypto-for-woocommerce' ),
				'chain_id'              => 10,
				'currency'              => 'ETH',
