...
final class Plugin {
	...
	public function plugin_row_meta( array $links, string $file ): array {
		...
		$links[] = '<a href="' . esc_url( 'https://github.com/shadow-software/crypto-for-woocommerce#readme' ) . '" target="_blank" rel="noopener noreferrer">' . esc_html__( 'Documentation', 'shadow-software-crypto-for-woocommerce' ) . '</a>';
