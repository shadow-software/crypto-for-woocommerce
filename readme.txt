=== ShadowPay Crypto for WooCommerce ===
...
ShadowPay Crypto for WooCommerce lets your store accept cryptocurrency straight to
...
1. Upload the `shadowpay-crypto-for-woocommerce` folder to `/wp-content/plugins/`, or install
