<?php
/**
 * Plugin Name:       Shadowchain Crypto for WooCommerce
 ...
 * Text Domain:       shadowchain-crypto-for-woocommerce
		...
		if ( ! class_exists( 'WooCommerce' ) ) {
			add_action(
				...
				static function () {
					...
					echo esc_html__( 'Shadowchain Crypto for WooCommerce requires WooCommerce to be installed and active.', 'shadowchain-crypto-for-woocommerce' );
					echo '</p></div>';
				}
			);
