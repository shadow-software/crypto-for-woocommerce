<?php
/**
 * Plugin Name:       ShadowPay Crypto for WooCommerce
 ...
 * Text Domain:       shadowpay-crypto-for-woocommerce
		...
		if ( ! class_exists( 'WooCommerce' ) ) {
			add_action(
				...
				static function () {
					...
					echo esc_html__( 'ShadowPay Crypto for WooCommerce requires WooCommerce to be installed and active.', 'shadowpay-crypto-for-woocommerce' );
					echo '</p></div>';
				}
			);
